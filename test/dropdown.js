...
// Call the function and get the elements
const elementsWithSquareBrackets = findElementsWithSquareBrackets();

// Output the elements found
console.log(elementsWithSquareBrackets);
